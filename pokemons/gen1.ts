import { ElementType, Rarity, Ability } from '@/types';
...
export const GEN1_RAW: RawCard[] = [
  ...
  { id: '092', name: 'Gastly', type: ElementType.GHOST, attack: 800, defense: 700, level: 1, rarity: Rarity.UNCOMMON },
  { id: '093', name: 'Haunter', type: ElementType.GHOST, attack: 1500, defense: 1200, level: 2 },
  { id: '094', name: 'Gengar', type: ElementType.GHOST, attack: 2400, defense: 1800, level: 3, ability: ABILITIES.revive },
  ...
  { id: '122', name: 'Mr. Mime', type: ElementType.PSYCHIC, attack: 1400, defense: 1400, level: 1, rarity: Rarity.UNCOMMON },
  { id: '123', name: 'Scyther', type: ElementType.BUG, attack: 2300, defense: 1800, level: 2, rarity: Rarity.RARE },
  { id: '124', name: 'Jynx', type: ElementType.PSYCHIC, attack: 1700, defense: 1400, level: 2, rarity: Rarity.UNCOMMON },
  { id: '125', name: 'Electabuzz', type: ElementType.ELECTRIC, attack: 2400, defense: 1800, level: 2, rarity: Rarity.RARE },
  { id: '126', name: 'Magmar', type: ElementType.FIRE, attack: 2400, defense: 1800, level: 2, rarity: Rarity.RARE },
  ...
  { id: '130', name: 'Gyarados', type: ElementType.WATER, attack: 3000, defense: 2600, level: 3, rarity: Rarity.EPIC },
  { id: '131', name: 'Lapras', type: ElementType.WATER, attack: 2600, defense: 2400, level: 3 },
  { id: '132', name: 'Ditto', type: ElementType.NORMAL, attack: 800, defense: 800, level: 1, rarity: Rarity.UNCOMMON },
  ...
  { id: '137', name: 'Porygon', type: ElementType.NORMAL, attack: 1500, defense: 1400, level: 1, rarity: Rarity.UNCOMMON },
  { id: '138', name: 'Omanyte', type: ElementType.WATER, attack: 900, defense: 1200, level: 1, rarity: Rarity.UNCOMMON },
  { id: '139', name: 'Omastar', type: ElementType.WATER, attack: 2200, defense: 2100, level: 2, rarity: Rarity.RARE },
  { id: '140', name: 'Kabuto', type: ElementType.WATER, attack: 900, defense: 1100, level: 1, rarity: Rarity.UNCOMMON },
  { id: '141', name: 'Kabutops', type: ElementType.WATER, attack: 2300, defense: 2000, level: 2, rarity: Rarity.RARE },
  { id: '142', name: 'Aerodactyl', type: ElementType.GROUND, attack: 2600, defense: 2200, level: 2, rarity: Rarity.EPIC },
  { id: '143', name: 'Snorlax', type: ElementType.NORMAL, attack: 2500, defense: 2500, level: 3, rarity: Rarity.EPIC },
  { id: '144', name: 'Articuno', type: ElementType.WATER, attack: 2800, defense: 2600, level: 3, rarity: Rarity.LEGENDARY, ability: ABILITIES.pressure },
  ...
  { id: '147', name: 'Dratini', type: ElementType.DRAGON, attack: 900, defense: 800, level: 1, rarity: Rarity.UNCOMMON },
  { id: '148', name: 'Dragonair', type: ElementType.DRAGON, attack: 1800, defense: 1600, level: 2, rarity: Rarity.RARE },
  { id: '149', name: 'Dragonite', type: ElementType.DRAGON, attack: 3000, defense: 2600, level: 3, rarity: Rarity.EPIC, ability: ABILITIES.regenerate },
