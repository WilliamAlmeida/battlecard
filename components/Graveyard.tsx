...
export const Graveyard: React.FC<GraveyardProps> = ({ playerGrave, npcGrave, isOpen: externalOpen, onToggle, restrictToMine }) => {
  ...
  return (
    <div className={`fixed right-0 top-[300px] z-[30] transition-transform duration-300 ${isOpen ? 'translate-x-0' : 'translate-x-[calc(100%-56px)]'} ${isOpen ? '' : 'pointer-events-none'}`}>
