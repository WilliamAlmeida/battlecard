...
export const BattleLog: React.FC<BattleLogProps> = ({ logs, isOpen: externalOpen, onToggle }) => {
  ...
  return (
    <div className={`fixed right-0 top-[110px] sm:top-[140px] z-[35] transition-all duration-300 ${isOpen ? 'translate-x-0' : 'translate-x-[calc(100%-56px)]'} ${isOpen ? '' : 'pointer-events-none'}`}>
